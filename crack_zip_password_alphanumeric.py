#!/usr/bin/env python3
"""
Script untuk crack password ZIP dengan alphanumeric (a-z, A-Z, 0-9)
...
def crack_zip_password(zip_path, min_length, max_length):
    ...
    print(f"[*] Character set: a-z, A-Z, 0-9 ({len(CHARSET)} karakter)")
...
def main():
    ...
    print("="*60)
    print("ZIP Password Cracker - Alphanumeric Brute Force")
    print("Character Set: a-z, A-Z, 0-9 (62 karakter)")
    ...
    with open(LOG_FILE, 'w', encoding='utf-8') as log:
        log.write("="*60 + "\n")
        log.write("ZIP Password Cracking Results (Alphanumeric)\n")
        log.write(f"Length Range: {MIN_LENGTH}-{MAX_LENGTH} karakter\n")
        log.write(f"Character Set: a-z, A-Z, 0-9\n")
        log.write("="*60 + "\n\n")
